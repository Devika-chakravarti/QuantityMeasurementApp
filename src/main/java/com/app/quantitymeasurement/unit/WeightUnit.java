 ...
 * WeightUnit
 *
 * Enumeration representing supported weight measurement units in the Quantity
 * Measurement system.
 *
 * Supported weight units: - KILOGRAM (base unit) - GRAM - POUND
 *
...
public enum WeightUnit implements IMeasurable, SupportsArithmetic {
	...
	/**
	 * Converts the given unit value to the base unit (KILOGRAM). Result is rounded
	 * to 6 decimal places for precision.
	 *
	...
	/**
	 * Converts a value from KILOGRAM to the current unit. Result is rounded to 6
