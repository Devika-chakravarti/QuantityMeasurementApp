 ...
 *
 * This DTO encapsulates the essential information required for performing
 * quantity measurement operations such as comparison, conversion, addition,
 * subtraction, and division. It stores the quantity value, unit of measurement,
 * and measurement type.
 *
 * The DTO is primarily used to transfer data between the Application Layer,
 * Controller Layer, and Service Layer without exposing internal domain models.
 *
 * Supported measurement categories: - Length (FEET, INCHES, YARDS, CENTIMETERS)
 * - Volume (LITRE, MILLILITRE, GALLON) - Weight (KILOGRAM, GRAM, POUND) -
 * Temperature (CELSIUS, FAHRENHEIT, KELVIN)
 *
 * Each category defines its own unit enumeration which implements the
 * IMeasurableUnit interface. The enum constants are made public so they have
 * visibility outside the package.
 *
 * @author Developer
 * @version 16.0
 * @since 1.0
...
public class QuantityDTO {
	 ...
	 *
	 * All unit enumerations inside this DTO implement this interface to provide a
	 * common contract for retrieving unit metadata (unit name and measurement
	 * type).
	 */
	...
	/**
	 * Enumeration representing supported length units. Made public for visibility
	...
	/**
	 * Enumeration representing supported volume units. Made public for visibility
	 * outside the entity package.
	 */
	...
	/**
	 * Enumeration representing supported weight units. Made public for visibility
	 * outside the entity package.
	 */
	...
	/**
	 * Enumeration representing supported temperature units. Made public for
	 * visibility outside the entity package.
	 */
