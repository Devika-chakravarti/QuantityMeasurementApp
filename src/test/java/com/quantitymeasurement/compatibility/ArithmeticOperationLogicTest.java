...
/*
 * ArithmeticOperationLogicTest:
 * -----------------------------
 * This test class validates the generic Quantity class logic for:
 * - addition
 * - subtraction
 * - division
 *
...
public class ArithmeticOperationLogicTest {
	...
	/*
	 * ADD: ---- Checks cross-unit addition for length.
	 */
	@Test
	...
	/*
	 * ADD: ---- Checks explicit target unit addition for weight.
	 */
	@Test
	...
	/*
	 * SUBTRACT: --------- Checks cross-unit subtraction for length.
	 */
	@Test
	...
	/*
	 * SUBTRACT: --------- Checks explicit target unit subtraction for volume.
	 */
	@Test
	...
	/*
	 * SUBTRACT: --------- Checks negative subtraction result.
	 */
	@Test
	...
	/*
	 * DIVIDE: ------- Checks same-unit division.
	 */
	@Test
	...
	/*
	 * DIVIDE: ------- Checks cross-unit division for length.
	 */
	@Test
	...
	/*
	 * DIVIDE: ------- Checks divide-by-zero handling.
	 */
	@Test
	...
	/*
	 * VALIDATION: ----------- Checks null operand handling across add, subtract,
	 * divide.
	 */
	@Test
	...
	/*
	 * VALIDATION: ----------- Checks that cross-category operations are rejected
	 * consistently.
	 */
	@Test
	...
	/*
	 * VALIDATION: ----------- Checks null target unit handling for add and
	 * subtract.
	 */
	@Test
	...
	/*
	 * IMMUTABILITY: ------------- Ensures original quantities are unchanged after
	 * operations.
	 */
	@Test
