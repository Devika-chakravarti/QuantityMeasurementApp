...
/*
 * TargetUnitSpecificationTest:
 * ----------------------------
 * This test class checks addition in QuantityLength
 * when an explicit target unit is provided.
 *
 * It verifies:
 * - result value in different target units
 * - result unit correctness
 * - commutativity
